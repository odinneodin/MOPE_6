...
for g in range(100):
    ...
    Y1 = [round(6.1 + 5.4 * X1[i] + 0.2 * X2[i] + 7.4 * X3[i] + 8.8 * X1kv[i] + 0.8 * X2kv[i] + 5.0 * X3kv[i] + 4.5 * X12[i] + 0.5 * X13[i] + 4.7 * X23[i] + 2.6 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
    Y2 = [round(6.1 + 5.4 * X1[i] + 0.2 * X2[i] + 7.4 * X3[i] + 8.8 * X1kv[i] + 0.8 * X2kv[i] + 5.0 * X3kv[i] + 4.5 * X12[i] + 0.5 * X13[i] + 4.7 * X23[i] + 2.6 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
    Y3 = [round(6.1 + 5.4 * X1[i] + 0.2 * X2[i] + 7.4 * X3[i] + 8.8 * X1kv[i] + 0.8 * X2kv[i] + 5.0 * X3kv[i] + 4.5 * X12[i] + 0.5 * X13[i] + 4.7 * X23[i] + 2.6 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
    ...
    if Gp < Gt:
        ...
        d = 11
        for i in range(11):
            if ((abs(globals()[f'beta%s' % (i)]) / sbs) < ttabl):
                print("t%s <ttabl, b%s не значимий" % (i,i))
                print("вийшло")
                for_task.append(globals()['b%s' % i ])
                globals()['b%s' % i ] = 0
                d = d - 1
